...
<?php include('reusable/nav.php')?>
  ...
  <?php 
      $query = "SELECT ad.id, ad.animal_name, ad.height, ad.weight, ad.color, ad.lifespan, ad.diet, ad.habitat, ad.predators, ad.avg_speed, ad.countries,ad.image_path, li.scientifc_name, li.conservation_status FROM animal_dataset ad JOIN lifespan_info li ON ad.animal_name = li.common_name 
  ...
  <div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="row">
            <?php 
              $is_admin = isset($_SESSION['admin']) && $_SESSION['admin']['first_name'] === 'admin';
              ...
              <div class="card">
                ...
                <div class="card-footer">
                  <div class="row">
                    <div class="col">';
                    if ($is_admin) {
                      echo '<form action="update-lifespan.php" method="GET">
                            <input type="hidden" name="id" value="'.$animal['id']. '">
      ...
      echo '</div>
                    <div class="col">';
                    if ($is_admin) {
                      echo '<form action="inc/deletelifespan.php" method="GET">
                            <input type="hidden" name="id" value="'.$animal['id']. '">
