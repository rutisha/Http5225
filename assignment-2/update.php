...
<?php include('reusable/nav.php') ?>
  ...
  <div class="container-fluid">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <form action="inc/updateanimal.php" method="POST"  enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <img src="<?php echo $result['image_path']; ?>" alt="<?php echo $result['animal_name']; ?>" class="img-thumbnail mb-3" style="max-width: 200px;">
            </div>
            <div class="mb-3">
